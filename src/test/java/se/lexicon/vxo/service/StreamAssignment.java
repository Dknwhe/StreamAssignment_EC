...
public class StreamAssignment {
    ...
    public void task9(){
        ...
        //Write code here
                            ...
                            // lyckas inte får id,namn, och fullnamn till collect to-list.
       // dtoList = people.stream().map(person -> person.getDateOfBirth().isBefore(date)).filter(person -> new PersonDto());
    ...
    public void task10(){
        ...
        //Write code here
                ...
                // filtrera ut en person med personId från "people" , får fram födelsedagen och gör en DataTimeFormatter med eeee dddd MMMM YYYY , stora bokstäver. funkar ej...
        //optional = people.stream().filter(person -> person.getPersonId() == personId).findFirst().filter(person -> person.getDateOfBirth().format(DateTimeFormatter.ofPattern("eeee dddd MMMM YYYY")).toUpperCase());
    ...
    public void task11(){
        ...
        //Write code here
                ...
                // Summan blir fel.
        //averageAge = people.stream().mapToInt(personToAge).sum();
    ...
    public void task12(){
        ...
        // Filtrera ut "people" och får ut namnet. Sortera alla namn på StringBuilder "palindromes", kasta om till string och sortera på "Arrays" Object . Funkar ej...
        //result = people.stream().filter(person -> person.getFirstName().equalsIgnoreCase(new StringBuilder(person.getFirstName())
                //.reverse().toString())).sorted().toArray(String[]::new);
    ...
    public void task14(){
        ...
        // Funkar ej...
        //_2020_dates = Stream.iterate(LocalDate.parse("2020-01-01").lengthOfYear()).toArray(LocalDate[]::new);
